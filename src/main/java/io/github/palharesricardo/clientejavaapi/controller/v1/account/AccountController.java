package io.github.palharesricardo.clientejavaapi.controller.v1.account;
...
import io.github.palharesricardo.clientejavaapi.exception.AccountNotFoundException;
...
@Log4j2
@RestController
@RequestMapping("/api-cliente/v1/accounts")
public class AccountController {
	...
	/**
	 * Method that creates a account in the cliente Java API.
	 * 
	 * @author Ricardo Palhares
	 * @since 04/01/2021
	 * 
	 ...
	 */
	@PostMapping
	public ResponseEntity<Response<AccountDTO>> create(@RequestHeader(value=clienteApiUtil.HEADER_cliente_API_VERSION, 
	...
	public ResponseEntity<Response<List<AccountDTO>>> findByAccountNumber(@RequestHeader(value=clienteApiUtil.HEADER_cliente_API_VERSION, defaultValue="${api.version}") 
		String apiVersion, @RequestHeader(value=clienteApiUtil.HEADER_API_KEY, defaultValue="${api.key}") String apiKey, 
		...
		MultiValueMap<String, String> headers = new LinkedMultiValueMap<>();
		headers.add(clienteApiUtil.HEADER_cliente_API_VERSION, apiVersion);
		headers.add(clienteApiUtil.HEADER_API_KEY, apiKey);
	...
	public ResponseEntity<Response<AccountDTO>> findById(@RequestHeader(value=clienteApiUtil.HEADER_cliente_API_VERSION, 
		defaultValue="${api.version}") String apiVersion, @RequestHeader(value=clienteApiUtil.HEADER_API_KEY, defaultValue="${api.key}") 
